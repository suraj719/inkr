...
import { Xmark, VideoPlay, Stop } from "../assets/icons";
  ...
  return (
    <div className="collabCreate">
      ...
      <button onClick={startSession}>
        <VideoPlay /> <span>Start session</span>
      </button>
    </div>
  );
}
  ...
  return (
    <div className="collabInfo">
      ...
      <div className="endCollab">
        <button type="button" onClick={endSession} style={{ color: 'red' }}>
          <Stop /> <span>Stop session</span>
        </button>
      </div>
    </div>
  );
